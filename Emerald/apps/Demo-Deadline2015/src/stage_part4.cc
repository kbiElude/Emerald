...
/** TODO */
PRIVATE void _stage_part4_configure_timeline(demo_timeline timeline,
                                             void*         unused)
{
    const demo_timeline_video_segment_pass part_4_video_segment_passes[] =
    {
        {
    ...
    demo_timeline_video_segment            part_4_video_segment = NULL;
    ...
    demo_timeline_add_video_segment(timeline,
                                   ...
                                   &part_4_video_segment);

    demo_timeline_video_segment_add_passes(part_4_video_segment,
                                           1, /* n_passes */
                                           part_4_video_segment_passes);
}
...
PUBLIC void stage_part4_deinit(ogl_context context)
{
    /* Nothing to deinit at the moment */
}

/** Please see header for specification */
PUBLIC void stage_part4_init(demo_loader loader)
{
    demo_loader_op_configure_timeline configure_timeline_op;

    configure_timeline_op.pfn_configure_timeline_proc = _stage_part4_configure_timeline;
