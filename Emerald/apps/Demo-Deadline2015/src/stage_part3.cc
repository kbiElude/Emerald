...
PRIVATE void _stage_part3_configure_timeline(demo_timeline timeline,
                                             void*         unused)
{
    const demo_timeline_video_segment_pass part_3_video_segment_passes[] =
    {
        {
    ...
    demo_timeline_video_segment            part_3_video_segment = NULL;
    ...
    demo_timeline_add_video_segment(timeline,
                                   ...
                                   &part_3_video_segment);

    demo_timeline_video_segment_add_passes(part_3_video_segment,
                                           1, /* n_passes */
                                           part_3_video_segment_passes);
}
