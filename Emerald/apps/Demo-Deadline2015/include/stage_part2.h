#ifndef STAGE_PART2_H
#define STAGE_PART2_H

#include "shared.h"
#include "ogl/ogl_types.h"

/** Deinitializes all GL objects created to render part 2 */
PUBLIC RENDERING_CONTEXT_CALL void stage_part2_deinit(ogl_context context);

/** Initializes all GL objects created to render part 2 */
PUBLIC RENDERING_CONTEXT_CALL void stage_part2_init(ogl_context context);
