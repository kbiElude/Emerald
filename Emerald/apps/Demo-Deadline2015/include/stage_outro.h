#ifndef STAGE_OUTRO_H
#define STAGE_OUTRO_H

#include "shared.h"
#include "ogl/ogl_types.h"

/** Deinitializes all GL objects created to render outro stage */
PUBLIC RENDERING_CONTEXT_CALL void stage_outro_deinit(ogl_context context);

/** Initializes all GL objects created to render outro stage */
