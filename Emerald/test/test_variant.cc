...
TEST(VariantTest, PoolManagement)
{
    ...
    ASSERT_NE(variant_2, variant_3);
    ASSERT_NE(variant_1, (void*)NULL);
    ASSERT_NE(variant_2, (void*)NULL);
    ASSERT_NE(variant_3, (void*)NULL);
    ...
    ASSERT_EQ(new_variant, variant_2);

    system_variant new_variant_2 = system_variant_create(SYSTEM_VARIANT_INTEGER);
    ASSERT_EQ(new_variant_2, variant_3);

    system_variant new_variant_3 = system_variant_create(SYSTEM_VARIANT_BOOL);
    ASSERT_NE(new_variant_3, (void*)variant_1);
    ASSERT_NE(new_variant_3, (void*)variant_2);
    ASSERT_NE(new_variant_3, (void*)variant_3);
    ASSERT_NE(new_variant_3, (void*)new_variant);
    ASSERT_NE(new_variant_3, (void*)new_variant_2);
}
