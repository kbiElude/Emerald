 ...
 */
PUBLIC EMERALD_API void system_critical_section_enter(__in system_critical_section);

/** TODO */
PUBLIC EMERALD_API system_thread_id system_critical_section_get_owner(__in system_critical_section);

/** Leaves a critical section
 *
 *  @param system_critical_section Critical section to leave.
 */
PUBLIC EMERALD_API void system_critical_section_leave(__in system_critical_section);
 ...
 */
PUBLIC EMERALD_API void system_critical_section_release(__in __deallocate(mem) system_critical_section);

/** TODO */
PUBLIC EMERALD_API bool system_critical_section_try_enter(__in system_critical_section);
