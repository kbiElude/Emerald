 ...
 */
PUBLIC EMERALD_API void system_thread_pool_submit_single_task(__notnull system_thread_pool_task_descriptor);
 ...
 */
PUBLIC EMERALD_API void system_thread_pool_submit_single_task_group(__notnull system_thread_pool_task_group_descriptor);
...
PUBLIC EMERALD_API system_thread_pool_task_descriptor system_thread_pool_create_task_descriptor_handler_with_event_signal(system_thread_pool_task_priority,
                                                                                                                          PFNSYSTEMTHREADPOOLCALLBACKPROC      execution_handler,
                                                                                                                          system_thread_pool_callback_argument execution_handler_argument,
                                                                                                                          system_event                         event); 
 ...
 */
PUBLIC EMERALD_API void system_thread_pool_release_task_group_descriptor(__deallocate(mem) system_thread_pool_task_group_descriptor);
 ...
 *
 *  @param system_thread_pool_task_group_descriptor Task group to insert the new task in.
 *  @param system_thread_pool_task_descriptor       Task to insert.
 */
PUBLIC EMERALD_API void system_thread_pool_insert_task_to_task_group(system_thread_pool_task_group_descriptor, system_thread_pool_task_descriptor);
