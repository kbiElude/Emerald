 ...
 */
PUBLIC EMERALD_API void system_read_write_mutex_release(__in __deallocate(mem) system_read_write_mutex);

/** TODO */
PUBLIC EMERALD_API bool system_read_write_mutex_is_write_locked(__in system_read_write_mutex);
