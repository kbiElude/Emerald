 ...
 * 
 * Basic saturation implementation. The fragment shader uses "uv" attribute.
 *
...
REFCOUNT_INSERT_DECLARATIONS(shaders_fragment_saturate, shaders_fragment_saturate)
 ...
 */
PUBLIC EMERALD_API shaders_fragment_saturate shaders_fragment_saturate_create(__in __notnull ogl_context, __in __notnull system_hashed_ansi_string name);
