...
REFCOUNT_INSERT_DECLARATIONS(shaders_vertex_fullscreen, shaders_vertex_fullscreen)
 ...
 */
PUBLIC EMERALD_API shaders_vertex_fullscreen shaders_vertex_fullscreen_create(__in __notnull ogl_context,
                                                                              __in           bool,
 ...
 **/
PUBLIC EMERALD_API ogl_shader shaders_vertex_fullscreen_get_shader(__in __notnull shaders_vertex_fullscreen);
