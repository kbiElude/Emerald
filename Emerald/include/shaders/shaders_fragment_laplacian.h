...
REFCOUNT_INSERT_DECLARATIONS(shaders_fragment_laplacian, shaders_fragment_laplacian)
 ...
 */
PUBLIC EMERALD_API shaders_fragment_laplacian shaders_fragment_laplacian_create(__in __notnull ogl_context, __in __notnull system_hashed_ansi_string name);
