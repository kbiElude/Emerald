...
REFCOUNT_INSERT_DECLARATIONS(shaders_fragment_sobel, shaders_fragment_sobel)
 ...
 */
PUBLIC EMERALD_API shaders_fragment_sobel shaders_fragment_sobel_create(__in __notnull ogl_context, __in __notnull system_hashed_ansi_string name);
