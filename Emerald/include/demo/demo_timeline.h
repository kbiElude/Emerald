 ...
 *
 *  This function constructs the segment by taking a @param n_passes number of @param passes. Each pass
 *  is defined by a rendering callback which should be used to generate the output(s) of the segment.
 *
 *  When rendering the frame, the passes will be called in submission order. Hence, the function assumes
 *  there are no inter-segment dependencies and it is your responsibility to ensure the order is correct,
 *  if n-th pass requires data generated by (n-1)-th pass.
 *
