...
enum ogl_context_state_cache_property
{
    ...
    /* settable, GLenum */
    OGL_CONTEXT_STATE_CACHE_PROPERTY_POLYGON_MODE_BACK_FACE,

    /* settable, GLenum */
    OGL_CONTEXT_STATE_CACHE_PROPERTY_POLYGON_MODE_FRONT_FACE,
...
enum ogl_context_state_cache_sync_bit
{
    ...
    STATE_CACHE_SYNC_BIT_ACTIVE_LINE_WIDTH           = 1 << 7,
    STATE_CACHE_SYNC_BIT_ACTIVE_MIN_SAMPLE_SHADING   = 1 << 8,
    STATE_CACHE_SYNC_BIT_ACTIVE_N_PATCH_VERTICES     = 1 << 9,
    STATE_CACHE_SYNC_BIT_ACTIVE_POLYGON_MODE         = 1 << 10,
    STATE_CACHE_SYNC_BIT_ACTIVE_POLYGON_OFFSET_STATE = 1 << 11,
    STATE_CACHE_SYNC_BIT_ACTIVE_PROGRAM_OBJECT       = 1 << 12,
    STATE_CACHE_SYNC_BIT_ACTIVE_READ_FRAMEBUFFER     = 1 << 13,
    STATE_CACHE_SYNC_BIT_ACTIVE_RENDERBUFFER         = 1 << 14,
    STATE_CACHE_SYNC_BIT_ACTIVE_RENDERING_MODES      = 1 << 15,
    STATE_CACHE_SYNC_BIT_ACTIVE_SCISSOR_BOX          = 1 << 16,
    STATE_CACHE_SYNC_BIT_ACTIVE_TEXTURE_UNIT         = 1 << 17,
    STATE_CACHE_SYNC_BIT_ACTIVE_VERTEX_ARRAY_OBJECT  = 1 << 18,
    STATE_CACHE_SYNC_BIT_ACTIVE_VIEWPORT             = 1 << 19,
    STATE_CACHE_SYNC_BIT_BLENDING                    = 1 << 20,
