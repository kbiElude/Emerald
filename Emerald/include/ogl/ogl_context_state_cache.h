...
enum ogl_context_state_cache_sync_bit
{
    ...
    STATE_CACHE_SYNC_BIT_ACTIVE_CULL_FACE           = 1 << 2,
    STATE_CACHE_SYNC_BIT_ACTIVE_DEPTH_FUNC          = 1 << 3,
    STATE_CACHE_SYNC_BIT_ACTIVE_PROGRAM_OBJECT      = 1 << 4,
    STATE_CACHE_SYNC_BIT_ACTIVE_SCISSOR_BOX         = 1 << 5,
    STATE_CACHE_SYNC_BIT_ACTIVE_TEXTURE_UNIT        = 1 << 6,
    STATE_CACHE_SYNC_BIT_ACTIVE_VERTEX_ARRAY_OBJECT = 1 << 7,
    STATE_CACHE_SYNC_BIT_ACTIVE_VIEWPORT            = 1 << 8,
    STATE_CACHE_SYNC_BIT_BLENDING                   = 1 << 9,
