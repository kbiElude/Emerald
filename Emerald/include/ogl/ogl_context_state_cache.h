...
enum ogl_context_state_cache_sync_bit
{
    ...
    STATE_CACHE_SYNC_BIT_ACTIVE_PROGRAM_OBJECT      = 1 << 3,
    STATE_CACHE_SYNC_BIT_ACTIVE_SCISSOR_BOX         = 1 << 4,
    STATE_CACHE_SYNC_BIT_ACTIVE_TEXTURE_UNIT        = 1 << 5,
    STATE_CACHE_SYNC_BIT_ACTIVE_VERTEX_ARRAY_OBJECT = 1 << 6,
    STATE_CACHE_SYNC_BIT_ACTIVE_VIEWPORT            = 1 << 7,
    STATE_CACHE_SYNC_BIT_BLENDING                   = 1 << 8,
