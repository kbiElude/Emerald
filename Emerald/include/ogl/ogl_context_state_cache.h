...
enum ogl_context_state_cache_sync_bit
{
    ...
    STATE_CACHE_SYNC_BIT_ACTIVE_POLYGON_OFFSET_STATE = 1 << 10,
    STATE_CACHE_SYNC_BIT_ACTIVE_PROGRAM_OBJECT       = 1 << 11,
    STATE_CACHE_SYNC_BIT_ACTIVE_READ_FRAMEBUFFER     = 1 << 12,
    STATE_CACHE_SYNC_BIT_ACTIVE_RENDERBUFFER         = 1 << 13,
    STATE_CACHE_SYNC_BIT_ACTIVE_RENDERING_MODES      = 1 << 14,
    STATE_CACHE_SYNC_BIT_ACTIVE_SCISSOR_BOX          = 1 << 15,
    STATE_CACHE_SYNC_BIT_ACTIVE_TEXTURE_UNIT         = 1 << 16,
    STATE_CACHE_SYNC_BIT_ACTIVE_VERTEX_ARRAY_OBJECT  = 1 << 17,
    STATE_CACHE_SYNC_BIT_ACTIVE_VIEWPORT             = 1 << 18,
    STATE_CACHE_SYNC_BIT_BLENDING                    = 1 << 19,
