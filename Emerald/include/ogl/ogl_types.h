...
/* Enumerator that describes OpenGL texture type.
 *
 * NOTE: Clients should always use RAL texture type instead! */
typedef enum
{
    OGL_TEXTURE_TYPE_GL_TEXTURE_1D                   = GL_TEXTURE_1D,
    OGL_TEXTURE_TYPE_GL_TEXTURE_1D_ARRAY             = GL_TEXTURE_1D_ARRAY,
    OGL_TEXTURE_TYPE_GL_TEXTURE_2D                   = GL_TEXTURE_2D,
    OGL_TEXTURE_TYPE_GL_TEXTURE_2D_ARRAY             = GL_TEXTURE_2D_ARRAY,
    OGL_TEXTURE_TYPE_GL_TEXTURE_2D_MULTISAMPLE       = GL_TEXTURE_2D_MULTISAMPLE,
    OGL_TEXTURE_TYPE_GL_TEXTURE_2D_MULTISAMPLE_ARRAY = GL_TEXTURE_2D_MULTISAMPLE_ARRAY,
    OGL_TEXTURE_TYPE_GL_TEXTURE_3D                   = GL_TEXTURE_3D,
    OGL_TEXTURE_TYPE_GL_TEXTURE_BUFFER               = GL_TEXTURE_BUFFER,
    OGL_TEXTURE_TYPE_GL_TEXTURE_CUBE_MAP             = GL_TEXTURE_CUBE_MAP,
    OGL_TEXTURE_TYPE_GL_TEXTURE_CUBE_MAP_ARRAY       = GL_TEXTURE_CUBE_MAP_ARRAY,
    OGL_TEXTURE_TYPE_GL_TEXTURE_RECTANGLE            = GL_TEXTURE_RECTANGLE,
    OGL_TEXTURE_TYPE_UNKNOWN                         = GL_NONE
} ogl_texture_type;
