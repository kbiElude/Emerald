...
typedef enum
{
    OGL_TEXTURE_INTERNALFORMAT_GL_BGR                         = GL_BGR,
    OGL_TEXTURE_INTERNALFORMAT_GL_BGRA                        = GL_BGRA,
    OGL_TEXTURE_INTERNALFORMAT_GL_COMPRESSED_RED              = GL_COMPRESSED_RED,
    OGL_TEXTURE_INTERNALFORMAT_GL_COMPRESSED_RED_RGTC1        = GL_COMPRESSED_RED_RGTC1,
    OGL_TEXTURE_INTERNALFORMAT_GL_COMPRESSED_RG               = GL_COMPRESSED_RG,
    OGL_TEXTURE_INTERNALFORMAT_GL_COMPRESSED_RG_RGTC2         = GL_COMPRESSED_RG_RGTC2,
    OGL_TEXTURE_INTERNALFORMAT_GL_COMPRESSED_RGB              = GL_COMPRESSED_RGB,
    OGL_TEXTURE_INTERNALFORMAT_GL_COMPRESSED_RGBA             = GL_COMPRESSED_RGBA,
    ...
    OGL_TEXTURE_INTERNALFORMAT_GL_COMPRESSED_SRGB             = GL_COMPRESSED_SRGB,
    OGL_TEXTURE_INTERNALFORMAT_GL_COMPRESSED_SRGB_ALPHA       = GL_COMPRESSED_SRGB_ALPHA,
    ...
    OGL_TEXTURE_INTERNALFORMAT_GL_RED                         = GL_RED,
    OGL_TEXTURE_INTERNALFORMAT_GL_RG                          = GL_RG,
    ...
    OGL_TEXTURE_INTERNALFORMAT_GL_RGB                         = GL_RGB,
    ...
    OGL_TEXTURE_INTERNALFORMAT_GL_RGBA                        = GL_RGBA,
