...
typedef enum
{
     ...
     *       and raGL_utils_get_ral_program_uniform_type_for_ogl_enum(). */
    ...
    RAL_PROGRAM_UNIFORM_TYPE_IMAGE_1D,
    RAL_PROGRAM_UNIFORM_TYPE_IMAGE_1D_ARRAY,
    RAL_PROGRAM_UNIFORM_TYPE_IMAGE_2D,
    RAL_PROGRAM_UNIFORM_TYPE_IMAGE_2D_ARRAY,
    RAL_PROGRAM_UNIFORM_TYPE_IMAGE_2D_MULTISAMPLE,
    RAL_PROGRAM_UNIFORM_TYPE_IMAGE_2D_MULTISAMPLE_ARRAY,
    RAL_PROGRAM_UNIFORM_TYPE_IMAGE_2D_RECT,
    RAL_PROGRAM_UNIFORM_TYPE_IMAGE_3D,
    RAL_PROGRAM_UNIFORM_TYPE_IMAGE_BUFFER,
    RAL_PROGRAM_UNIFORM_TYPE_IMAGE_CUBE,
    RAL_PROGRAM_UNIFORM_TYPE_IMAGE_CUBE_MAP_ARRAY,
    RAL_PROGRAM_UNIFORM_TYPE_INT,
    RAL_PROGRAM_UNIFORM_TYPE_INT_IMAGE_1D,
    RAL_PROGRAM_UNIFORM_TYPE_INT_IMAGE_1D_ARRAY,
    RAL_PROGRAM_UNIFORM_TYPE_INT_IMAGE_2D,
    RAL_PROGRAM_UNIFORM_TYPE_INT_IMAGE_2D_ARRAY,
    RAL_PROGRAM_UNIFORM_TYPE_INT_IMAGE_2D_MULTISAMPLE,
    RAL_PROGRAM_UNIFORM_TYPE_INT_IMAGE_2D_MULTISAMPLE_ARRAY,
    RAL_PROGRAM_UNIFORM_TYPE_INT_IMAGE_2D_RECT,
    RAL_PROGRAM_UNIFORM_TYPE_INT_IMAGE_3D,
    RAL_PROGRAM_UNIFORM_TYPE_INT_IMAGE_BUFFER,
    RAL_PROGRAM_UNIFORM_TYPE_INT_IMAGE_CUBE,
    RAL_PROGRAM_UNIFORM_TYPE_INT_IMAGE_CUBE_MAP_ARRAY,
    ...
    RAL_PROGRAM_UNIFORM_TYPE_UNSIGNED_INT_IMAGE_1D,
    RAL_PROGRAM_UNIFORM_TYPE_UNSIGNED_INT_IMAGE_1D_ARRAY,
    RAL_PROGRAM_UNIFORM_TYPE_UNSIGNED_INT_IMAGE_2D,
    RAL_PROGRAM_UNIFORM_TYPE_UNSIGNED_INT_IMAGE_2D_ARRAY,
    RAL_PROGRAM_UNIFORM_TYPE_UNSIGNED_INT_IMAGE_2D_MULTISAMPLE,
    RAL_PROGRAM_UNIFORM_TYPE_UNSIGNED_INT_IMAGE_2D_MULTISAMPLE_ARRAY,
    RAL_PROGRAM_UNIFORM_TYPE_UNSIGNED_INT_IMAGE_2D_RECT,
    RAL_PROGRAM_UNIFORM_TYPE_UNSIGNED_INT_IMAGE_3D,
    RAL_PROGRAM_UNIFORM_TYPE_UNSIGNED_INT_IMAGE_BUFFER,
    RAL_PROGRAM_UNIFORM_TYPE_UNSIGNED_INT_IMAGE_CUBE,
    RAL_PROGRAM_UNIFORM_TYPE_UNSIGNED_INT_IMAGE_CUBE_MAP_ARRAY,
