                                                                         ...
                                                                         postprocessing_blur_gaussian_resolution blur_resolution)
{
    ...
    if (blur_ptr->ping_pong_rt == nullptr)
    {
        ...
        ping_pong_rt_create_info.description            = system_hashed_ansi_string_create_by_merging_two_strings(system_hashed_ansi_string_get_buffer(blur_ptr->name),
        ...
        ping_pong_rt_create_info.unique_name            = nullptr;
