...
PRIVATE void _ogl_context_retrieve_GL_function_pointers(_ogl_context* context_ptr)
{
    ...
    func_ptr_table_entry func_ptr_table[] =
    {
        ...
        {&context_ptr->entry_points_private.pGLDepthRangeIndexed,                           "glDepthRangeIndexed"},
        ...
        {&context_ptr->entry_points_private.pGLPolygonMode,                                 "glPolygonMode"},
    ...
    context_ptr->entry_points_gl.pGLDepthRangeIndexed                           = ogl_context_wrappers_glDepthRangeIndexed;
    ...
    context_ptr->entry_points_gl.pGLPolygonMode                                 = ogl_context_wrappers_glPolygonMode;
...
/** Please see header for specification */
PUBLIC bool ogl_context_is_extension_supported(ogl_context               context,
