...
/* Internal variables */
#ifdef INCLUDE_KRIVANEK_FAST_SH_Y_ROTATION
    const char* sh_rotate_krivanek_y_vp_template_body = "#version 430 core\n"
                                                        "\n"
                                                        "#define N_BANDS (%d)\n"
                                                        "\n"
...
const char* sh_rotate_xyz_vp_body = "#version 430 core\n"
                                    "\n"
                                    "#define N_BANDS (%d)\n"
                                    "\n"
...
const char* sh_rotate_z_vp_template_body = "#version 430 core\n"
                                           "\n"
                                           "#define N_BANDS (%d)\n"
                                           "\n"
