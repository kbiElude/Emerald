                                                              ...
                                                              void*                       out_result_ptr)
{
    ...
    switch (property)
    {
        case RAL_TEXTURE_FORMAT_PROPERTY_HAS_STENCIL_DATA:
        {
            *(bool*) out_result_ptr = format_data[texture_format].has_stencil_data;
        ...
        case RAL_TEXTURE_FORMAT_PROPERTY_NAME:
        {
            *(const char**) out_result_ptr = format_data[texture_format].name;
