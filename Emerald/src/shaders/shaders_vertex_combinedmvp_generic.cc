...
REFCOUNT_INSERT_IMPLEMENTATION(shaders_vertex_combinedmvp_generic, shaders_vertex_combinedmvp_generic, _shaders_vertex_combinedmvp_generic);
...
PUBLIC EMERALD_API shaders_vertex_combinedmvp_generic shaders_vertex_combinedmvp_generic_create(__in __notnull ogl_context context, __in __notnull system_hashed_ansi_string name)
{
    ...
    ASSERT_DEBUG_SYNC(result_object != NULL, "Out of memory while instantiating _shaders_vertex_combinedmvp_generic object.");
    ...
    REFCOUNT_INSERT_INIT_CODE_WITH_RELEASE_HANDLER(result_object, 
                                                   ...
                                                   system_hashed_ansi_string_create_by_merging_two_strings("\\Combined MVP Generic Vertex Shaders\\", system_hashed_ansi_string_get_buffer(name)) );
