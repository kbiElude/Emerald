...
/* Internal variables */
const char* tex2D_fragment_linear_shader_body_not_reverted =
    "#version 430 core\n"
    "\n"
    "in vec2 uv;\n"
    "\n"
...
const char* tex2D_fragment_linear_shader_body_reverted =
    "#version 430 core\n"
    "\n"
    "in vec2 uv;\n"
    "\n"
...
{
    _shaders_fragment_texture2D_linear* data_ptr = reinterpret_cast<_shaders_fragment_texture2D_linear*>(ptr);
...
{
    _shaders_fragment_texture2D_linear* result_object_ptr = nullptr;
    ral_shader                          shader            = nullptr;

    /* Create the shader */
    system_hashed_ansi_string shader_body       (system_hashed_ansi_string_create(should_revert_y ? tex2D_fragment_linear_shader_body_reverted
                                   ...
                                   &shader) )
    {
        ASSERT_DEBUG_SYNC(false,
                          "Could not create a new RAL instance");
    ...
    result_object_ptr = new (std::nothrow) _shaders_fragment_texture2D_linear;
    ...
    /* Return the object */
    return reinterpret_cast<shaders_fragment_texture2D_linear>(result_object_ptr);
...
/** Please see header for specification */
PUBLIC EMERALD_API ral_shader shaders_fragment_texture2D_linear_get_shader(shaders_fragment_texture2D_linear shader)
{
