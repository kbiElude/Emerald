...
/* Internal variables */
const char* tex2D_fragment_filmic_customizable_shader_body_not_reverted = "#version 420 core\n"
                                                                          "\n"
                                                                          "in vec2 uv;\n"
                                                                          "\n"
                                                                          "uniform data\n"
...
const char* tex2D_fragment_filmic_customizable_shader_body_reverted = "#version 420 core\n"
                                                                      "\n"
                                                                      "in vec2 uv;\n"
                                                                      "\n"
                                                                      "uniform data\n"
