...
/* Internal variables */
const char* tex2D_fragment_filmic_customizable_shader_body_not_reverted =
    "#version 430 core\n"
    "\n"
    "in vec2 uv;\n"
    "\n"
...
const char* tex2D_fragment_filmic_customizable_shader_body_reverted =
    "#version 430 core\n"
    "\n"
    "in vec2 uv;\n"
    "\n"
...
{
    _shaders_fragment_texture2D_filmic_customizable* data_ptr = reinterpret_cast<_shaders_fragment_texture2D_filmic_customizable*>(ptr);
...
{
    _shaders_fragment_texture2D_filmic_customizable* result_object_ptr = nullptr;
    ...
    /* Return the object */
    return reinterpret_cast<shaders_fragment_texture2D_filmic_customizable>(result_object_ptr);
