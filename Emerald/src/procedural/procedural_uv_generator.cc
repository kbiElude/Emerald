...
PRIVATE void _procedural_uv_generator_init_generator_po(_procedural_uv_generator* generator_ptr)
{
    ...
    ral_buffer         input_params_ub_buffer_ral = NULL;
    ...
    ral_program_block_buffer_get_property(generator_ptr->input_params_ub,
                                         ...
                                         &input_params_ub_buffer_ral);
    ral_buffer_get_property              (input_params_ub_buffer_ral,
                                             ...
                                             _procedural_uv_generator_object* object_ptr)
{
    ...
    ral_program_block_buffer_set_nonarrayed_variable_value(generator_ptr->input_params_ub,
    ...
    ral_program_block_buffer_sync(generator_ptr->input_params_ub);

    GLuint      input_params_ub_bo_id           = 0;
    raGL_buffer input_params_ub_bo_raGL         = NULL;
    ral_buffer  input_params_ub_bo_ral          = NULL;
    ...
    input_params_ub_bo_raGL = ral_context_get_buffer_gl(generator_ptr->context,
                                                        input_params_ub_bo_ral);

    raGL_buffer_get_property(input_params_ub_bo_raGL,
                             RAGL_BUFFER_PROPERTY_ID,
